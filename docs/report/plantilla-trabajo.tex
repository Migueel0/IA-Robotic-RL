...
\begin{pseudo}*
    \hd{\fn{genera\_secuencia}}(\textit{mapa}, \textit{destino}, \textit{estado}, \textit{accion}, \textit{politica}, \textit{pasos}) \\*
    \multicolumn{2}{l}{\textbf{Entrada}: \textit{mapa}, \textit{destino}, \textit{estado}, \textit{accion}, \textit{politica}, \textit{pasos}} \\*
    \multicolumn{2}{l}{\textbf{Salida}: Secuencia de estados, acciones y recompensas} \\*
    \multicolumn{2}{l}{\textbf{Algoritmo}:} \\
